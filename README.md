...
si comme ici, le fichier n'est pas accessible, vous pourrez le [télécharger en cliquant ici](https://github.com/BaptMania/OpenCV-CUDA-Windows/blob/main/VisualStudioSetup.exe),
